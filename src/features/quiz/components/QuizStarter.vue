...
import { getMinutesInMs, getSecondsInMs } from '@/shared/utils/time';
...
const formData = reactive({
  ...
  maxTerms: quizSettings.value.maxTerms,
  maxDuration: quizSettings.value.maxDuration,
  timer: quizSettings.value.timer
});
...
const handleSubmit = () => {
  quizSettings.value.maxTerms = formData.maxTerms;
  quizSettings.value.maxDuration = formData.maxDuration;
  quizSettings.value.timer = formData.timer;
